...
viewsRouter.use(
  ...
  loginRequired,
  isAdmin,
  serveStatic('admin-category-list'),
);
viewsRouter.use(
  '/admin-category-edit',
  loginRequired,
  isAdmin,
  serveStatic('admin-category-edit'),
);
viewsRouter.use(
  '/admin-main',
  loginRequired,
  isAdmin,
  serveStatic('admin-main'),
);
viewsRouter.use(
  '/admin-order-detail',
  loginRequired,
  isAdmin,
  serveStatic('admin-order-detail'),
);
viewsRouter.use(
  '/admin-order-edit',
  loginRequired,
  isAdmin,
  serveStatic('admin-order-edit'),
);
viewsRouter.use(
  '/admin-order-list',
  loginRequired,
  isAdmin,
  serveStatic('admin-order-list'),
);
viewsRouter.use(
  '/admin-product-adder',
  loginRequired,
  isAdmin,
  serveStatic('admin-product-adder'),
);
viewsRouter.use(
  '/admin-product-detail',
  loginRequired,
  isAdmin,
  serveStatic('admin-product-detail'),
);
viewsRouter.use(
  '/admin-product-list',
  loginRequired,
  isAdmin,
  serveStatic('admin-product-list'),
);
viewsRouter.use(
  '/admin-user-detail',
  loginRequired,
  isAdmin,
  serveStatic('admin-user-detail'),
);
viewsRouter.use(
  '/admin-user-list',
  loginRequired,
  isAdmin,
  serveStatic('admin-user-list'),
);
viewsRouter.use(
  '/admin-user-order',
  loginRequired,
  isAdmin,
  serveStatic('admin-user-order'),
);
