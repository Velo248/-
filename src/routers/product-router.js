...
//     const offsetMax = Math.ceil(productsCount / limit);
//     if (offset < 1 || offsetMax < offset) {
//       throw new Error(`offset 범위는 1-${offsetMax}입니다.`);
//     }
//     if (limit < 1 || productsCount < limit) {
//       throw new Error(`limit 범위는 1-${productsCount}입니다.`);
//     }
//     const newQuery = {
//       sortBy: sortKey[sortBy],
//       orderBy: sortOrderType[sortOrder],
...
//       limit,
//     };
//     const { products, ...query } = await productService.getProductsByQuery(
//       newQuery,
//     );
//     res.status(200).json({ ...query, products, total: productsCount });
//   } catch (error) {
//     next(error);
//   }
// });
